...
You can see what models you've downloaded with `list_models()`. To download a model, specify the name of the model. 
...
Get the vector embedding of some prompt/text. By default, the embeddings are normalized to length 1, which means the following:
